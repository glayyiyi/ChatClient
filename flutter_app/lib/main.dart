...
Future main() async {
  ...
  // print(
  //     "IndexHtml Path=========================:${path.join(webDir.path, 'index.html')}");
                ...
                onDownloadStartRequest: (controller, url) async {
                  ...
                  if (url.url.scheme == "data") {
                    String? outputFile = await FilePicker.platform.saveFile(
                        ...
                        fileName:
                            'OneAIChat_${DateTime.now().microsecondsSinceEpoch}.txt',
...
Future<void> _saveBase64ImageToLocal(String base64Image) async {
  ...
  String? outputFile = await FilePicker.platform.saveFile(
      dialogTitle: 'Please select an output file:',
      fileName: 'OneAIChat_${DateTime.now().microsecondsSinceEpoch}.png',
      bytes: bytes);
